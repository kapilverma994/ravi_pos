  ...
  <div id="wrapper">
    ...
    <a class="collapse-item" href="{{route('product.create')}}">Add Product</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseForm123" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
    <a class="collapse-item" href="{{route('order.create')}}">Create Order</a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseForm1234" aria-expanded="true"
          aria-controls="collapseForm">
          <i class="fab fa-fw fa-wpforms"></i>
          <span>Settings</span>
        </a>
        <div id="collapseForm1234" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
    <a class="collapse-item" href="{{route('setting.edit',1)}}">Site Setting</a>
            {{-- <a class="collapse-item" href="{{route('order.index')}}">View Order</a> --}}
          </div>
        </div>
      </li>
